...
/**wrote separate file c_Prameters.java*******/
    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
    {
		doPost(req,res);
			...
			public void Update_Plane_Table(c_Parameters param)
			{
								...
								/*			
									...
									*/
											...
											Flight_Master_st.setString(1,(String)hashTable.get("Plane_No"));
											Flight_Master_st.setString(2,(String)hashTable.get("Plane_Name"));
